...
class GitCommit
{
	 ...
	 */
	public function __construct($hash, GitRepository $repository)
	{
		$this->hash = $hash;
	 ...
	 *
	 * @return GitCommit[] array of parent commits
	 */
	...
	/**
	 * Retrieves the contents of a file at a specific commit.  If binary, it will return the binary content.
	 *
